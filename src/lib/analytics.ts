...
const visitorStorageKey = 'docuseal-analytics-visitor-id'
const sessionStorageKey = 'docuseal-analytics-session'
const pendingEventsStorageKey = 'docuseal-analytics-pending-events'
